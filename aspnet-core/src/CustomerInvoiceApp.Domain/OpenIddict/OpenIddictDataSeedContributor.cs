...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("CustomerInvoiceApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "CustomerInvoiceApp", DisplayName = "CustomerInvoiceApp API", Resources = { "CustomerInvoiceApp" }
            });
        }
    }
